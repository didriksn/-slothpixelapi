...
request('https://api.slothpixel.me/api/skyblock/bazaar/ENCHANTED_ACACIA_LOG', { json: true }, (err, res, body) => {
  ...
  let arr = res["body"]["sell_summary"].slice(lowestSellOfferThatShowsUpInTheSellSummaryObject - 5, lowestSellOfferThatShowsUpInTheSellSummaryObject);

  arr.forEach(i => console.log(i["pricePerUnit"]));
});
